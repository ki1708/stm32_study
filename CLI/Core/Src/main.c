...
/* USER CODE BEGIN PFP */
// printf -> _write ?��?���??hhhh?��?��?��?��?��? ?��?��?��?��?�� HAL_UART_Transmit�???? ?��?��?�� 출력?��?���???? �????�????
...
void PeriphCommonClock_Config(void)
{
  LL_RCC_PLLSAI_ConfigDomain_LTDC(LL_RCC_PLLSOURCE_HSE, LL_RCC_PLLSAIM_DIV_4, 50, LL_RCC_PLLSAIR_DIV_2, LL_RCC_PLLSAIDIVR_DIV_2);
